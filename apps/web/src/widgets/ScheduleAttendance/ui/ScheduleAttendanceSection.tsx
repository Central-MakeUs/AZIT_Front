...
import * as styles from '@/widgets/ScheduleAttendance/styles/ScheduleAttendanceSection.css';
import { ScheduleAttendanceSkeleton } from '@/widgets/ScheduleAttendance/ui/ScheduleAttendanceSkeleton';
