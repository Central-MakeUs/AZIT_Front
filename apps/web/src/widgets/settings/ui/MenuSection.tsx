...
import * as styles from '@/widgets/settings/styles/MenuSection.css';
import { MenuItem } from '@/widgets/settings/ui/MenuItem';
...
export function MenuSection({ section }: MenuSectionProps) {
  ...
  const getStatusLabelForItem = (item: MenuItemType): string | null => {
